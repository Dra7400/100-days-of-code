...
FORM_URL = "https://docs.google.com/forms/d/e/1FAIpQLSf0QJnodMvoX_3lds4KFCSxG8j8W2oCKUFPs_49gN0aVQ4dyQ/viewform?usp=sf_link"
...
def enter_details(entry):
    ...
    # fill out the fields
    driver.find_element(by=By.XPATH, value='//*[@id="mG61Hd"]/div[2]/div/div[2]/div[3]/div/div/div[2]/div/div[1]/div/div[1]/input').send_keys(entry["address"])
    driver.find_element(by=By.XPATH, value='//*[@id="mG61Hd"]/div[2]/div/div[2]/div[2]/div/div/div[2]/div/div[1]/div/div[1]/input').send_keys(entry["price"])
    driver.find_element(by=By.XPATH, value='//*[@id="mG61Hd"]/div[2]/div/div[2]/div[1]/div/div/div[2]/div/div[1]/div/div[1]/input').send_keys(url)
    time.sleep(1)
    # submit the entry
    driver.find_element(by=By.XPATH, value='//*[@id="mG61Hd"]/div[2]/div/div[3]/div[1]/div/div').click()
