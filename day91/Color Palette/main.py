...
open_btn = Button(text="Select Image", font=(WORD_FONT, 20), width=25, fg=WORD_COLOR, highlightbackground='blue', command=get_img_colors)
copy_btn = Button(text="Copy Text", font=(WORD_FONT, 20), width=25, fg=WORD_COLOR, highlightbackground='blue', command=copy_to_clipboard)
clear_btn = Button(text="Clear Text", font=(WORD_FONT, 20), width=25, fg=WORD_COLOR, highlightbackground='blue', command=clear_text)
