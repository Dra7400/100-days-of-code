...
open_btn = Button(text="1. Select PDF", font=(WORD_FONT, 35), width=15, fg=WORD_COLOR, highlightbackground='blue', command=open_pdf)
play_btn = Button(text="2. Play Audio", font=(WORD_FONT, 35), width=15, fg=WORD_COLOR, highlightbackground='blue', command=play_audio)
